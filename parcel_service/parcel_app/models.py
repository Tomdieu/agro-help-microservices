...
class Token(models.Model):
    ...
    user:fields.ForeignKeyRelation[User] = fields.OneToOneField("models.User",related_name="token")
...
class Parcel(models.Model):
    ...
    user:fields.ForeignKeyRelation[User] = fields.ForeignKeyField("models.User",related_name='parcels')
...
class CultureParcel(models.Model):
    id = fields.IntField(pk=True)
    culture = fields.ForeignKeyField("models.Culture",related_name='parcels')
    parcel:fields.ForeignKeyRelation[Parcel] = fields.ForeignKeyField("models.Parcel",related_name='cultures')
